  ...
  return (
    <TopicLayout section="data-modeling" slug={slug}>
      ...
      <ERDiagram
        ...
        caption="両端に縦棒 1 本 = 「必ず 1、多くて 1」。上のルールでは「両方の上限が 1」= 3 番目と 4 番目のルールを規定している (「必ず持つ」= 下限側は参加制約ページで扱う)。"
      />
      ...
      <ERDiagram
        ...
        caption="部長側は縦棒 (必ず 1)、部下側は縦棒 + 鳥足 (必ず 1 以上)。上のルールでは「部下の上限が 1」= 3 番目、「部長の上限は無制限」= 4 番目を規定している。"
      />
      ...
      <ERDiagram
        ...
        caption="両端に縦棒 + 鳥足 = 「必ず 1 以上」。上のルールでは「両方の上限が N」= 3 番目と 4 番目を規定 (これが N:M の本質)。この形は必ず連関実体に分解する。下限側は 参加制約 ページで扱う。"
      />
