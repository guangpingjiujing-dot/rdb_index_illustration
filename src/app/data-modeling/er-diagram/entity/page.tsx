...
const faq = [
  ...
  {
    q: "何をエンティティにすべきかの基準は？",
    a: "(1) 複数値を持ちうるか (「生徒の履修科目」など複数持てる項目)、(2) 独立にライフサイクルを持つか (親と別に登録・更新・削除される)、(3) 複数の他エンティティから参照されるか、の 3 点で判断する。どれかに Yes なら独立エンティティに切り出す。",
  },
  {
    ...
    <TopicLayout section="data-modeling" slug={slug}>
      ...
      <ul>
        ...
        <li>
          ...
          「教員 (担任)」を学級からも、履修からも、成績表からも参照する → 独立エンティティ「教員」を用意して、
          複数のエンティティから FK で参照する構造にする
        </li>
      </ul>
      <p>
