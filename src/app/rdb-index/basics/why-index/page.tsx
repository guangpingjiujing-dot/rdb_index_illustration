...
export default function Page() {
  return (
    <TopicLayout slug={slug}>
      ...
      <ul>
        <li>
          <a href="/rdb-index/basics/data-structure">ページと行ID</a> — フルスキャンで「1行ずつ読む」の実態は「ページ単位で読む」こと。物理的な仕組みを一段深く理解する。
        </li>
        <li>
          <a href="/rdb-index/btree">B-treeインデックス</a> — 最も使われる索引構造。フルスキャンとの差を体感できる。
        </li>
        <li>
          <a href="/rdb-index/hash">ハッシュインデックス</a> — 等価検索なら究極に速い方式。
        </li>
      </ul>
