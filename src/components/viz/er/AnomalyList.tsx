...
export const ANOMALIES: Anomaly[] = [
  ...
  {
    n: 8,
    title: "「発注」線の注文側に、縦棒と円が並んで参加制約が破綻している",
    hint: "注文側に | と ○ が両方あるが、これは何を意味する？",
    answer:
      "「発注」線の注文側は | (最大 1) の外側に ○ (最小 0) が並び、IE 記法として読むと「0..1」= 顧客からすると 発注する注文は 0 か 1 つ という任意参加になる。しかしこれは EC サイトの業務ルール「顧客は少なくとも 1 回は注文する見込みで登録する」「注文には必ず発注顧客がいる」と噛み合わない。参加制約 (必須 vs 任意) は業務ルールに合わせて片方に確定させて描くべき。",
    concept: "参加制約の破綻",
