...
export const dataModelingTopics: DataModelingTopic[] = [
  ...
  },
  {
    ...
    level: "basic",
    summary:
      "複合主キーの真部分集合に関数従属する非キー属性 (部分関数従属) を切り出して別テーブル化するのが 2NF。単一主キーのテーブルは自動的に 2NF を満たす点も整理する。",
    definition:
      "第2正規形とは、第1正規形を満たし、かつ非キー属性のすべてが候補キー全体に完全関数従属している (候補キーの真部分集合への部分関数従属を持たない) リレーションの状態をいう。",
    keywords: [
      "第2正規形",
      "2NF",
      "部分関数従属",
